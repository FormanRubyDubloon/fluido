    ...
    return (
      ...
      >
        <motion.div
          ...
          className="relative md:h-[800px] h-[calc(100svh-200px)]"
        >
          {/* Front face */}
          <div
            data-face="front"
            className="absolute inset-0 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-y-auto"
            style={{
